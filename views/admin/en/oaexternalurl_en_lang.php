...
$aLang = [
    'charset' => 'UTF-8',
    'OA_EXTPRODUCT_LABEL' => "Label for Url",
    'HELP_OA_EXTPRODUCT_LABEL' => "The label that is shown on the product page",
    'OA_EXTPRODUCT_URL' => "Url",
    'HELP_OA_EXTPRODUCT_URL' =>  "Url beginning with https://",
];